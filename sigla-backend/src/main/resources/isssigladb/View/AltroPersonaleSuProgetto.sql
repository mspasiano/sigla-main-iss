CREATE OR REPLACE FORCE VIEW ALTROPERSONALESUPROGETTO AS
        SELECT pa.CD_ANAG AS IdPersona,
                ...
                ADD_MONTHS(p.SCADENZA, 2) AS ScadenzaDifferita,
                ADD_MONTHS(p.ULTIMAPROROGA, 2) AS UltimaProrogaDifferita,
                p.TITOLO as TITOLO,
