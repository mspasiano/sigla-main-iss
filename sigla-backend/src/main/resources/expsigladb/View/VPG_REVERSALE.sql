...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE  VIEW "VPG_REVERSALE" ("ID", "CHIAVE", "SEQUENZA", "DESCRIZIONE", "CD_CDS", "ESERCIZIO", "PG_REVERSALE", "TI_RECORD", "ID_RIGA", "DT_EMISSIONE", "TI_REVERSALE", "TI_COMPETENZA_RESIDUO", "DS_CDS", "CD_UO_ORIGINE", "DS_UO_CDS", "CAB", "ABI", "NUMERO_CONTO", "CIN", "INTESTAZIONE", "DS_ABICAB", "VIA", "CAP", "DS_COMUNE", "CD_PROVINCIA", "IM_REVERSALE", "IM_REVERSALE_LETTERE", "CD_TERZO", "DENOMINAZIONE_SEDE", "VIA_SEDE", "CAP_COMUNE_SEDE", "DS_COMUNE_SEDE", "CD_PV_TERZO", "CODICE_FISCALE", "CD_TIPO_DOCUMENTO_AMM", "PG_DOC_AMM", "IM_REVERSALE_RIGA", "IM_REVERSALE_RIGA_LETTERE", "DS_REVERSALE_RIGA", "ESERCIZIO_ORI_ACCERTAMENTO", "PG_ACCERTAMENTO", "DS_ACCERTAMENTO", "CD_VOCE", "DS_VOCE", "CD_SOSPESO", "IM_ASSOCIATO", "DT_REGISTRAZ_SOSPESO", "UTCR", "DACR", "CD_SIOPE", "DS_SIOPE", "IM_SIOPE", "IBAN", "CD_CUP", "DS_CUP", "IM_CUP", "STATO", "DS_REVERSALE") AS
  SELECT
--
-- Date: 10/05/2007
-- Version: 1.4
