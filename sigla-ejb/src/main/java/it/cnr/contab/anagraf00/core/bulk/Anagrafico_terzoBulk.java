...
public class Anagrafico_terzoBulk extends Anagrafico_terzoBase {
    ...
    private V_anagrafico_terzoBulk terzo;
    ...
    public V_anagrafico_terzoBulk getTerzo() {
        return terzo;
    }
    ...
    public void setTerzo(V_anagrafico_terzoBulk newTerzo) {
        terzo = newTerzo;
    }
    ...
    public java.lang.String getDs_terzo() {
        return Optional.ofNullable(getTerzo())
                .flatMap(vAnagraficoTerzoBulk -> Optional.ofNullable(vAnagraficoTerzoBulk.getDenominazione_sede()))
                .orElse("");
    }
}
