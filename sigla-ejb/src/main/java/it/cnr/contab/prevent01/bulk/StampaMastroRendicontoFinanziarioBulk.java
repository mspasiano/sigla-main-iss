 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class StampaMastroRendicontoFinanziarioBulk extends OggettoBulk {
	...
	public boolean isTipoDecisionale() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_DECISIONALE.equals(this.getTi_stampa());
	}

	public boolean isTipoGestionale() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_GESTIONALE.equals(this.getTi_stampa());
	}

	public boolean isTipoPluriennale() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_PLURIENNALE.equals(this.getTi_stampa());
	}

	public boolean isPartePrima() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_PARTE_PRIMA.equals(this.getTi_parte());
	}

	public boolean isParteSeconda() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_PARTE_SECONDA.equals(this.getTi_parte());
	}

	public boolean isTipoGestioneEntrata() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_GESTIONE_ENTRATA.equals(this.getTi_gestione());
	}

	public boolean isTipoGestioneSpesa() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_GESTIONE_SPESA.equals(this.getTi_gestione());
	}

	public boolean isTipoAggregazioneScientifica() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_SCIENTIFICO.equals(this.getTi_aggregazione());
	}

	public boolean isTipoAggregazioneFinanziaria() {
		return StampaMastroRendicontoFinanziarioBulk.TIPO_FINANZIARIO.equals(this.getTi_aggregazione());
	}
}
