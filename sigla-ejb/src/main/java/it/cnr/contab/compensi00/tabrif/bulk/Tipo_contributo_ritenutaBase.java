...
public class Tipo_contributo_ritenutaBase extends Tipo_contributo_ritenutaKey implements Keyed {
	...
	/**
	 * Se impostato a true in fase di utilizzo (pagamento stipendi) genera partite di giro complete
	 * e, in fase di versamento, genera mandato di versamento
	 * Se impostato a false in fase di utilizzo (pagamento stipendi) genera partite di giro tronche
	 * e, in fase di versamento, non genera mandato di versamento
	 * @return Boolean
	 */
