...
public class VControlloDispObblScadBulk extends VControlloDispObblScadBase {

	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Table name: V_CONTROLLO_DISP_OBBLIGAZIONE_SCADENZARIO
	 **/
	public VControlloDispObblScadBulk() {
		super();
	}
