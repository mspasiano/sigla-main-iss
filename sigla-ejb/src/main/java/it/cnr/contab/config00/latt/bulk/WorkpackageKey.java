...
public class WorkpackageKey extends OggettoBulk implements KeyedPersistent {
	...
	public boolean equals(Object o) {
		...
		WorkpackageKey that = (WorkpackageKey) o;
		return Objects.equals(cd_linea_attivita, that.cd_linea_attivita) && Objects.equals(cd_centro_responsabilita, that.cd_centro_responsabilita);
	}

	@Override
	public int hashCode() {
		return Objects.hash(cd_linea_attivita, cd_centro_responsabilita);
	}
}
