...
public class Obbligazione_scadenzarioBulk extends Obbligazione_scadenzarioBase implements Cloneable, IScadenzaDocumentoContabileBulk {
    ...
    public void completeFrom(it.cnr.contab.docamm00.docs.bulk.Nota_di_credito_attiva_rigaBulk dettaglio) {
        ...
        imTotaleDettaglio = imTotaleDettaglio.setScale(2, RoundingMode.HALF_UP);
    ...
    public OggettoBulk initializeForInsert(it.cnr.jada.util.action.CRUDBP bp, it.cnr.jada.action.ActionContext context) {
        ...
        os.setStatus(STATUS_NOT_CONFIRMED);
	...
	public Integer getEsercizio_ordine() {
		return esercizio_ordine;
	}

	public void setEsercizio_ordine(Integer esercizio_ordine) {
		this.esercizio_ordine = esercizio_ordine;
	}

	public Long getPg_ordine() {
		return pg_ordine;
	}
