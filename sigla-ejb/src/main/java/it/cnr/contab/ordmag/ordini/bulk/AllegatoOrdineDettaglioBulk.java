...
public class AllegatoOrdineDettaglioBulk extends AllegatoGenericoBulk {
	...
	public AllegatoOrdineDettaglioBulk() {
		super();
	}

	public AllegatoOrdineDettaglioBulk(String storageKey) {
		super(storageKey);
