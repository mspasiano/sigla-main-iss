...
<% CRUDFatturaAttivaBP bp = (CRUDFatturaAttivaBP)BusinessProcess.getBusinessProcess(request);
	...
	if (fatturaAttiva instanceof Fattura_attiva_IBulk)
		...
		bp.getDettaglio().writeHTMLTable(pageContext,"righeNdCSet",true,false,true,"100%","auto;max-height:50vh;");
	else 
		bp.getDettaglio().writeHTMLTable(pageContext,"righeNdDSet",true,false,true,"100%","auto;max-height:50vh;"); %>
   ...
   <div class="Group card">
       ...
       <%	it.cnr.contab.docamm00.docs.bulk.Fattura_attiva_rigaBulk riga = (it.cnr.contab.docamm00.docs.bulk.Fattura_attiva_rigaBulk)bp.getDettaglio().getModel();
            if (riga != null && riga.getCollegatoCapitoloPerTrovato()) { %>
               <tr>
                   <td><% bp.getDettaglio().writeFormLabel(out,"pg_trovato");%></td>
                   <td><% bp.getDettaglio().writeFormInput(out,null,"pg_trovato",false,null,"");%></td>
               </tr>
               <tr><% bp.getDettaglio().writeFormField(out,"titoloTrovato");%></tr>
               <tr><% bp.getDettaglio().writeFormField(out,"inventoreTrovato");%></tr>
         <%	}  %>
       </table>
